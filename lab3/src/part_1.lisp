...
(write-to-file (concatenate 'string FOLDER "I_C.txt") C_p I_total 0 (- LENGTH-1 1))
(write-to-file (concatenate 'string FOLDER "U_R_C.txt") C_p U_R 0 (- LENGTH-1 1))
(write-to-file (concatenate 'string FOLDER "U_L_C.txt") C_p U_L 0 (- LENGTH-1 1))
(write-to-file (concatenate 'string FOLDER "U_C_C.txt") C_p U_C 0 (- LENGTH-1 1))
(write-to-file (concatenate 'string FOLDER "X_C_C.txt") C_p X_C 0 (- LENGTH-1 1))
(write-to-file (concatenate 'string FOLDER "X_L_C.txt") C_p X_L 0 (- LENGTH-1 1))
(write-to-file (concatenate 'string FOLDER "S_C.txt") C_p S 0 (- LENGTH-1 1))
(write-to-file (concatenate 'string FOLDER "cosPhi1_C.txt") C_p cos_phi 0 (- LENGTH-1 1))
