...
set title 'Векторная диаграмма "Звезда с нейтральным проводом (несимметричная система)"'
set grid
...
# I neutral
set arrow from 0,0 to I_N_x,I_N_y lc rgb 'orange' lw 2

set label 'I_N' at I_N_x,I_N_y offset 1,1
...
set output "plots/pictures/asterisk_neutral_asym.png"
plot NaN notitle
